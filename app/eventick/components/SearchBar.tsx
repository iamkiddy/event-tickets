...
export const SearchBar: React.FC<{ isCompact?: boolean }> = ({ isCompact }) => {
  ...
  const buttonClasses = isCompact
    ? "h-8 px-4 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-full text-sm"
    : "h-12 px-8 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-full font-semibold shadow-md hover:shadow-lg transition-all duration-200";
